...
use ironrdp_egfx::client::{
    BitmapUpdate, CacheImportOutcome, CacheImportTile, GraphicsPipelineClient, GraphicsPipelineHandler, Surface,
};
...
use ironrdp_egfx::pdu::{
    ...
    CapabilitySet, CapabilityVersion, Codec1Type, Color, CreateSurfacePdu, DeleteSurfacePdu, EndFramePdu, GfxPdu,
    MapSurfaceToOutputPdu, PixelFormat, Point, ResetGraphicsPdu, SolidFillPdu, StartFramePdu, SurfaceToCachePdu,
